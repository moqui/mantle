    ...
    <fo:page-sequence master-reference="letter-portrait">
        ...
        <fo:static-content flow-name="xsl-region-after" font-size="8pt">
            <fo:block border-top="thin solid black">
                ...
                <fo:block text-align="center">Picklist for Shipment #${shipmentId} -- ${ec.l10n.format(shipment.estimatedShipDate, dateFormat)} -- Page <fo:page-number/></fo:block>
            </fo:block>
        </fo:static-content>
        ...
        <fo:flow flow-name="xsl-region-body">
            ...
            <#if reservedLocationInfoList?has_content>
                ...
                <fo:table table-layout="fixed" width="7.5in">
                    ...
                    <fo:table-body>
                    <#list reservedLocationInfoList as locationInfo>
